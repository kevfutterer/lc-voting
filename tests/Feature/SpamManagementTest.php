...
class SpamManagementTest extends TestCase
{
     ...
     */
    public function test_shows_mark_idea_as_spam_livewire_component_when_user_has_authorization(): void
    {
    ...
    public function test_does_not_shows_mark_idea_as_spam_livewire_component_when_user_does_not_have_authorization(): void
    {
        $idea = Idea::factory()->create();
    ...
    public function test_marking_an_idea_as_spam_works_when_user_has_authorization(): void
    {
        $user = User::factory()->create();
    ...
    public function test_marking_an_idea_does_not_show_on_menu_when_user_does_not_have_authorization(): void
    {
        $user = User::factory()->create();
    ...
    public function test_marking_an_idea_shows_on_menu_when_user_has_authorization(): void
    {
        $user = User::factory()->create();
    ...
    public function test_marking_an_idea_does_not_show_on_menu_when_user_has_not_authorization(): void
    {
        $idea = Idea::factory()->create();
