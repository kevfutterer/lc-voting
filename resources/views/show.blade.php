                    ...
                    <div 
                        ...
                        <button 
                            ...
                            <ul 
                                ...
                                class=" text-left absolute w-44 font-semibold bg-white shadow-dialog rounded-xl py-3 ml-8">
                                <li>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
                ...
                <div 
                    ...
                    <form action="" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <button type="button"
                                class="flex items-center text-sm justify-center h-11 w-1/2 bg-blue font-semibold rounded-full border text-white border-blue hover:bg-blue-hover transition duration-150 ease-in px-2 py-2" >
                                <span class="ml-1">Post comment</span>
                            </button>
                            <button type="button"
                                class="flex items-center justify-center w-32 h-11 text-xs bg-gray-200 font-semibold rounded-full border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-2 py-2" >
            ...
            <div 
                ...
                <button type="button"
                    @click="isOpen = !isOpen"
                    class="flex items-center justify-center w-36 h-11 text-sm bg-gray-200 font-semibold rounded-full border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-2 py-2" >
                    ...
                    <form action="" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                                <label class="flex items-center">
                                    <input type="radio" id="radio-1" checked="" class="bg-gray-200 text-black border-none" value="1" name="radio-direct">
                                    <span class="ml-2">Open</span>
                                </label>
                            </div>
                            <div>
                                <label class="flex items-center">
                                    <input type="radio" id="radio-1" checked="" class="bg-gray-200 text-blue border-none" value="1" name="radio-direct">
                                    <span class="ml-2">Considering</span>
                                </label>
                            </div>
                            <div>
                                <label class="flex items-center">
                                    <input type="radio" id="radio-1" checked="" class="bg-gray-200 text-yellow border-none" value="1" name="radio-direct">
                                    <span class="ml-2">In Progess</span>
                                </label>
                            </div>
                            <div>
                                <label class="flex items-center">
                                    <input type="radio" id="radio-1" checked="" class="bg-gray-200 text-green border-none" value="1" name="radio-direct">
                                    <span class="ml-2">Implemented</span>
                                </label>
                            </div>
                            <div>
                                <label class="flex items-center">
                                    <input type="radio" id="radio-1" checked="" class="bg-gray-200 text-red border-none" value="1" name="radio-direct">
                        ...
                        <div>
                            <label class="font-normal inline-flex items-center">
                                <input class="rounded bg-gray-200" type="checkbox" name="notify_voters" checked="" id="">
                        ...
                        <div 
                            ...
                            <button 
                                ...
                                <ul 
                                    ...
                                    @click.away = "isOpen = false"
                                    @keydown.excape.window="isOpen = false"
                                    class="z-10 text-left absolute w-44 font-semibold bg-white shadow-dialog rounded-xl py-3 ml-8">
                                    <li>
                                        <a href="" class="hover:bg-gray-100 block px-5 py-3 transition duration-150 ease-in">Mark as spam</a>
                                    </li>
                                    <li>
